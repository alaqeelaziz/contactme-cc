        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-4 rounded-xl font-semibold text-sm text-white hover:opacity-90 active:scale-[0.98] transition-all"
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 py-4 rounded-xl font-semibold text-sm hover:opacity-90 active:scale-[0.98] transition-all"
          ...
          <p className="text-center text-xs text-[var(--text-muted)]">PNG, JPG — حد أقصى 5MB</p>
